     ...
     <div>
      <div className='grid grid-cols-2 text-accent text-3xl sm:text-4xl'>
        <div className='space-y-2'>
          <h2 className="text-pink-600" data-aos="zoom-in-up">Typescript</h2>
          <h2 className="text-pink-600" data-aos="zoom-in-up">Next.js</h2>
          <h2 className="text-pink-600" data-aos="zoom-in-up">Html</h2>
        </div>
        <div  className='space-y-2 '>
          <h2 className="text-pink-600" data-aos="zoom-in-up">Tailwind</h2>
          <h2 className="text-pink-600" data-aos="zoom-in-up">CSS</h2>
          <h2 className="text-pink-600" data-aos="zoom-in-up">Python</h2>
        </div>
      </div>
     </div>
    </div> 
